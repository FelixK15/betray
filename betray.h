...
extern void		betray_view_direction(float *matrix);  /* A 4X4 rotation matrix  that should be aplied to all drawing in order to support multi display solutions and headmounted dispålays. */
